...
import type { Source, SourceJob } from "@app-types/index"
import {
  getConnectorImage,
...
const SourceEditComponent = () => {
	...
	const [connectorType, setConnectorType] =
		useState<string>(DEFAULT_SOURCE_TYPE)
...
const SourceEdit = withAbortController(SourceEditComponent)
